    ...
    return (
        <div className='vh-modal-overlay' onClick={handleClose}>
            <div className='vh-modal-container' onClick={e => e.stopPropagation()}>
                <button className='vh-modal-close' onClick={handleClose}>
                    ×
                </button>
                    ...
                    <div className='vh-setting-card'>
                        <div className='vh-card-info'>
                            ...
                            <div>
                                ...
                                <span className='vh-card-desc'>
                                    {localize('Virtual trades before switching to real')}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className='vh-card-info'>
                            ...
                            <div>
                                <span className='vh-card-title'>
                                    {localize('No of wins on Real before switching to VH')}
                                </span>
