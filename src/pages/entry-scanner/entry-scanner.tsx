        ...
        <div className="entry-scanner-container">
            ...
            <div className="entry-scanner-content">
                    ...
                    <div className="card-center-row">
                        <div className="card-number-emboss">
                            {entry_scanner.scan_result ? (
                                ...
                                <span className="standby-text">•••• •••• •••• {entry_scanner.target_single_symbol || '1HZ100V'}</span>
                            )}
                        </div>
                ...
                <div className="neumorphic-tiles-grid">
                    <div
                        className={classNames('neumorphic-tile action', { active: entry_scanner.scan_phase === 'trading' })}
                    ...
                    <div className="neumorphic-tile metric">
                        ...
                        <div className="tile-text">
                            ...
                            <span className={classNames('tile-sub pnl-val', {
                        ...
                        <div className="trade-history-list">
                            {entry_scanner.trade_log.slice(0, 5).map((log, idx) => (
                                <div key={idx} className={classNames('history-row', log.result.toLowerCase())}>
                                    ...
                                    <span className={classNames('row-badge', log.result.toLowerCase())}>{log.result}</span>
                                    <span className="row-profit">{log.profit >= 0 ? '+' : ''}${log.profit.toFixed(2)}</span>
                                </div>
                            ))}
                        </div>
                    </div>
