...
const DIGIT_SYMBOLS = SYMBOLS.filter(s => s.category === 'Volatility' || s.category === 'Jump');
    ...
    return (
        <div className='space-y-1'>
            ...
            >
                ...
                <div
                    className='h-full transition-all duration-700'
                    style={{ width: `${oddPct}%`, background: 'linear-gradient(90deg,#f59e0b,#fbbf24)' }}
                />
            </div>
    ...
    return (
        <div className='space-y-1'>
            ...
            >
                <div
                    className='h-full transition-all duration-700'
                    style={{ width: `${normLow}%`, background: 'linear-gradient(90deg,#10b981,#34d399)' }}
                />
                <div
                    className='h-full transition-all duration-700'
                    style={{ width: `${normHigh}%`, background: 'linear-gradient(90deg,#ef4444,#f87171)' }}
                />
            </div>
            <div className='flex justify-between text-[8px] text-white/25'>
    ...
    return (
        <div className='grid grid-cols-5 gap-1'>
            {frequencies.map(df => {
                ...
                const arrow =
                    trend?.trendDirection === 'increasing' ? '▲' : trend?.trendDirection === 'decreasing' ? '▼' : '–';
                const arrowColor =
                ...
                return (
                    ...
                    >
                        ...
                        <div className='text-[7px] font-bold mt-0.5' style={{ color: arrowColor }}>
                            {arrow}
                        </div>
                        <div
...
function MarketRow({
    ...
    return (
        <div
            ...
            style={{
                borderColor: expanded ? 'rgba(214,26,140,0.25)' : 'rgba(255,255,255,0.07)',
        ...
        >
            ...
            >
                ...
                <div className='flex items-center gap-1 shrink-0'>
                    ...
                    {!loading && !topSignal && <span className='text-[8px] text-white/25'>No signal</span>}
                </div>
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className='pt-2 flex items-center gap-3 text-[9px] text-white/40'>
                                ...
                                <span>
                                    Last digit: <b className='text-white/70'>{state?.lastDigit}</b>
                                </span>
                            ...
                            {strategyIds.some(s => s === 'even_odd') && (
                                ...
                                >
                                    <div className='text-[9px] font-black text-white/50 uppercase tracking-wider'>
                                        Even vs Odd
                                    </div>
                            ...
                            {strategyIds.some(s => s === 'matches' || s === 'differs') && (
                                <div
                                    className='rounded-xl p-2.5 space-y-2'
                                    style={{
                                        background: 'rgba(214,26,140,0.04)',
                                        border: '1px solid rgba(214,26,140,0.12)',
                                    }}
                                >
                                    <div className='text-[9px] font-black text-white/50 uppercase tracking-wider'>
                                        Digit Analysis
                                ...
                                <div className='space-y-1.5'>
                                    ...
                                    {signals.map((sig, i) => (
                                        ...
                                        >
                                            ...
                                            {sig.tradeDirection && (
                                                <span className='text-[8px] font-black text-white/50 shrink-0'>
                                                    {sig.tradeDirection}
                                                </span>
                                            )}
                                        </div>
        ...
        return (
            <div className='flex flex-col h-full'>
                ...
                <div className='flex items-center gap-2 px-1 py-2'>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: showSymbolPicker ? 'rgba(255,255,255,0.07)' : 'transparent',
                        }}
                    >
                ...
                <div className='px-1 pb-2.5'>
                    <div className='text-[8px] font-black text-white/25 uppercase tracking-widest mb-1.5'>
                        Strategies
                    </div>
                    <div className='flex flex-wrap gap-1.5'>
                        {STRATEGIES.map(s => {
                            ...
                            return (
                                <button
                                    key={s.id}
                                    onClick={() => toggleStrategy(s.id as StrategyId)}
        ...
        <div className='fixed inset-0 z-50 flex flex-col overflow-hidden' style={{ background: '#07070d' }}>
            ...
            >
                <div
                    ...
                    style={{
                        background: 'linear-gradient(135deg,rgba(245,197,66,0.15),rgba(230,126,34,0.15))',
