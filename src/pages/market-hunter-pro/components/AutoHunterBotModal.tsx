...
export const AutoHunterBotModal: React.FC<AutoHunterBotModalProps> = ({
    ...
    setIsExecuting;
    void currentStake;
    void setCurrentStake;
    void setTotalTrades;
    void setWins;
    void setLosses;
    void setNetProfit;
    const [logs, setLogs] = useState<
        Array<{ id: string; time: string; msg: string; type: 'info' | 'win' | 'loss' | 'warn' }>
    >([]);
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                        ...
                        <div>
                            ...
                            <span style={{ fontSize: '0.85rem', color: '#94a3b8' }}>
                                Strategy: <strong style={{ color: '#38bdf8' }}>{strategyLabel}</strong> (
                                {selectedTradeType})
                            </span>
                        </div>
                    </div>
                    ...
                    {isRunning && (
                        ...
                        >
                            ...
                            >
                                <Loader2
                                    size={36}
                                    color={isSearching ? '#38bdf8' : '#eab308'}
                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                >
                                    ...
                                    <strong style={{ fontSize: '1.05rem', color: '#ffffff' }}>
                                        {isSearching
                                            ? 'Hunting High-Probability Entry Conditions...'
                                            : 'Purchasing & Settlement In Progress...'}
                                    </strong>
                                </div>
                                <p style={{ margin: 0, fontSize: '0.85rem', color: '#94a3b8' }}>{statusMessage}</p>
                            </div>
                        </div>
                    )}
                    ...
                    >
                        {logs.length === 0 ? (
                            <span style={{ color: '#64748b' }}>
                                Activity logs will appear here when the bot starts...
                            </span>
                        ) : (
                            logs.map(log => (
                                <div
