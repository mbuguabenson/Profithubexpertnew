        ...
        <div className='eo-cracker matches'>
            <div className='eo-cracker__header'>
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                    <div
                        className={classNames('mic-toggle-row', { active: matches_config.is_auto })}
                        style={{ padding: '0.4rem 0.8rem' }}
                        onClick={() => runInAction(() => (matches_config.is_auto = !matches_config.is_auto))}
                    >
            ...
            <div className='eo-section glass-panel'>
                ...
                <div
                    className='eo-entry-signal'
                    style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', background: 'none', border: 'none' }}
                >
                        ...
                        {[1, 2, 3, 4].map(s => (
                            <div
                                ...
                                style={{
                                    width: '1.8rem',
                                    height: '1.8rem',
                                    opacity: matches_config.verification_stage >= s ? 1 : 0.3,
                                }}
                            >
                                {s}
                            </div>
            ...
            <div className='mic-side-by-side'>
                        ...
                        <div className='intel-body'>
                            {digit_stats
                                ...
                                .map(stat => (
                                    <div
                                        key={stat.digit}
                                        className={classNames('intel-row', { 'is-last': stat.digit === last_digit })}
                                    >
                                        <div className='col-digit'>
                                            <span style={{ color: elite.includes(stat.digit) ? '#6366f1' : '#fff' }}>
                                                {stat.digit}
                                            </span>
                                            {elite[0] === stat.digit && (
                                                <span style={{ fontSize: '0.6rem', color: '#f59e0b' }}>[MOST]</span>
                                            )}
                                            {elite[2] === stat.digit && (
                                                <span style={{ fontSize: '0.6rem', color: '#f43f5e' }}>[LEAST]</span>
                                            )}
                                        </div>
                                        <div>{stat.rank}</div>
                                        <div style={{ color: stat.is_increasing ? '#10b981' : '#94a3b8' }}>
                ...
                <div className='mic-controls'>
                    <div className='eo-section glass-panel'>
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        style={{
                                            width: '100%',
                                            textAlign: 'center',
                                            borderColor: matches_config.is_auto
                                                ? 'transparent'
                        ...
                        <div
                            style={{ fontSize: '0.65rem', color: '#94a3b8', marginTop: '0.5rem', fontStyle: 'italic' }}
                        >
                            {matches_config.is_auto
                                ? 'Mode: Automated Discovery Active'
                                : 'Mode: Manual Targeting Active'}
                        </div>
                    </div>
                        ...
                        >
                            <div className='eo-exec-row' style={{ justifyContent: 'space-between' }}>
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        runInAction(() => (matches_config.stake = parseFloat(e.target.value)))
                                    }
                                />
                            </div>
                            <div className='eo-exec-row' style={{ justifyContent: 'space-between' }}>
                                ...
                                <input
                                    ...
                                    onChange={e =>
                                        runInAction(
                                            () => (matches_config.simultaneous_trades = parseInt(e.target.value))
                                        )
                                    }
                                />
                            </div>
                            <div
                                className='mic-toggle-row'
                                onClick={() =>
                                    runInAction(
                                        () => (matches_config.martingale_enabled = !matches_config.martingale_enabled)
                                    )
                                }
                            >
                                ...
                                <div
                                    className={classNames('toggle-switch', {
                                        active: matches_config.martingale_enabled,
                                    })}
                                />
                            </div>
                                ...
                                <div className='eo-exec-row' style={{ justifyContent: 'space-between' }}>
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            runInAction(
                                                () =>
                                                    (matches_config.martingale_multiplier = parseFloat(e.target.value))
                                            )
                                        }
                                    />
                                </div>
                    ...
                    <div className='eo-section glass-panel'>
                        ...
                        >
                            <div className='mic-toggle-row' onClick={() => toggleCondition(0)}>
                                ...
                                <div
                                    className={classNames('toggle-switch', {
                                        active: matches_config.enabled_conditions[0],
                                    })}
                                />
                            </div>
                            <div className='mic-toggle-row' onClick={() => toggleCondition(1)}>
                                ...
                                <div
                                    className={classNames('toggle-switch', {
                                        active: matches_config.enabled_conditions[1],
                                    })}
                                />
                            </div>
                            <div className='mic-toggle-row' onClick={() => toggleCondition(2)}>
                                ...
                                <div
                                    className={classNames('toggle-switch', {
                                        active: matches_config.enabled_conditions[2],
                                    })}
                                />
                            </div>
                            {matches_config.enabled_conditions[2] && (
                                <div className='eo-condition-row' style={{ paddingLeft: '1rem' }}>
                                    <select
                                        className='eo-select'
                                        value={matches_config.c3_op}
                                        onChange={e =>
                                            runInAction(() => (matches_config.c3_op = e.target.value as any))
                                        }
                                    >
                                        <option value='>'>{'>'}</option>
                                        <option value='>='>{'>='}</option>
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            runInAction(() => (matches_config.c3_val = parseFloat(e.target.value)))
                                        }
                                    />
                                    <span>%</span>
                                </div>
                            ...
                            <div className='mic-toggle-row' onClick={() => toggleCondition(3)}>
                                ...
                                <div
                                    className={classNames('toggle-switch', {
                                        active: matches_config.enabled_conditions[3],
                                    })}
                                />
                            </div>
                            {matches_config.enabled_conditions[3] && (
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        onChange={e =>
                                            runInAction(() => (matches_config.c1_count = parseInt(e.target.value)))
                                        }
                                    />
                                </div>
                            )}
            ...
            <div className='eo-section glass-panel'>
                ...
                <div className='eo-exec-btns'>
                    ...
                    <button
                        ...
                        onClick={() =>
                            trade_engine.executeManualTrade('matches', digit_cracker.symbol, client.currency || 'USD')
                        }
                    >
                        ONE-SHOT TRADE
                    </button>
