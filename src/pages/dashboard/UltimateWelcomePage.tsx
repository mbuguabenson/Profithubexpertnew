...
// Typing effect words
const TYPING_WORDS = ['AI Powered', 'Digit Trading', 'Automation', 'Risk Management', 'Market Analysis'];
...
export const UltimateWelcomePage = observer(
    ({ handleTabChange: _handleTabChange }: { handleTabChange: (active_number: number) => void }) => {
            ...
            <div className='ultimate-landing'>
                ...
                <div className='ultimate-landing__grid-overlay'>
                    <svg
                        ...
                        className='ultimate-landing__grid-svg'
                    >
                        <defs>
                ...
                <div className='ultimate-landing__layout-grid'>
                    ...
                    <div className='ultimate-landing__left-col'>
                        <div className='ultimate-landing__hero'>
                            ...
                            >
                                {localize(
                                    'Import an existing bot, create one from scratch, or launch an intelligent strategy powered by AI.'
                                )}
                            </motion.p>
                        </div>
                            ...
                            <div className='ultimate-landing__cards-grid'>
                                {cardData.map((card, index) => (
                                    ...
                                    >
                                        ...
                                        <div className='card__icon-wrap'>{card.icon}</div>
                ...
                <footer className='ultimate-landing__footer'>
                    <div className='footer-content'>
                        <div className='footer-left'>{localize('Powered by Deriv API')}</div>
                        <div className='footer-center'>
                            <span className='deriv-icon-glow' />
                            {localize('Ultimate Traders AI')} • {localize('Version 2.0')}
                        </div>
                        <div className='footer-right'>{localize('Secure • Fast • Intelligent')}</div>
                    </div>
                </footer>
            </div>
        );
