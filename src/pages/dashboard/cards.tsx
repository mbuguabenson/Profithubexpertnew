    ...
    const actionTiles = [
        {
            id: 'import',
            title: 'Import',
            icon: <Smartphone size={26} className="tile-icon text-purple" />,
            orbBg: 'orb-purple',
        ...
        },
        {
            id: 'smart-trader',
            title: 'Smart Trader',
            icon: <TrendingUp size={26} className="tile-icon text-emerald" />,
            orbBg: 'orb-emerald',
        ...
        },
        {
            id: 'free-bots',
            title: 'Free Bots',
            icon: <Bot size={26} className="tile-icon text-blue" />,
            orbBg: 'orb-blue',
        ...
        },
        {
            id: 'signal-tools',
            title: 'Signal Tools',
            icon: <Radio size={26} className="tile-icon text-amber" />,
            orbBg: 'orb-amber',
            ...
            >
                ...
                <div className="dash-gold-notice-card">
                    <div className="notice-left-text">
                        <strong className="text-amber">Don't have an Account?</strong> Use this link to create your account with Deriv.
                    </div>
                    <a
                ...
                {/* 4. 4 Main Soft Action Tiles in ONE LINE */}
