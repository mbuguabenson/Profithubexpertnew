...
const getStatsForStrategy = (analysis: any, strategy: string) => {
    ...
    if (strategy === 'even_odd') {
        const e = analysis.evenPercentage,
            o = analysis.oddPercentage;
        return {
            strength: Math.max(e, o),
            text: `Even ${e.toFixed(0)}% / Odd ${o.toFixed(0)}%`,
            details: { bias: e >= o ? 'even' : 'odd' },
        };
    }
    if (strategy === 'over_under') {
        ...
        return {
            strength,
            text: isOver
                ? `Over ${targetDigit}: ${strength.toFixed(0)}%`
                : `Under ${targetDigit}: ${strength.toFixed(0)}%`,
    ...
    if (strategy === 'rise_fall') {
        if (lastDigits.length >= 10) {
            ...
            return {
                strength: s,
                text: `${dir === 'rise' ? 'Rise' : 'Fall'}: ${s.toFixed(0)}%`,
                details: { bias: dir === 'rise' ? 'high' : 'low' },
            };
        }
    }
...
const mapSignalToBestSignal = (sig: any) => {
    ...
    if (strat === 'even_odd' || strat === 'pro_even_odd' || strat === 'super') {
        ...
        const trend =
            ...
            (sig.details.recommendation.toLowerCase().includes('rise') ? 'rise' : 'fall');
...
const Scanner = observer(() => {
    ...
    const [statsStrategy, setStatsStrategy] = useState<'even_odd' | 'over_under' | 'differs' | 'rise_fall' | 'matches'>(
        'even_odd'
    );
    ...
    const activeAnalysis =
        scanner.symbol_analysis[single_market_symbol] || scanner.symbol_analysis[current_signal?.symbol || 'R_100'];
    ...
    const disturberDigit = (() => {
        ...
        if (isUnderDominant && underPct >= 55) {
            ...
            if (overDigitsIn25.length >= 8) {
                ...
                overDigitsIn25.forEach(d => {
                    counts[d] = (counts[d] || 0) + 1;
                });
                const maxDigit = Object.keys(counts).reduce(
                ...
                >
                    <div className='mhp-scanner'>
                        ...
                        <div className='mhp-body'>
                                    ...
                                    <div className='mhp-card'>
                                        <div className='mhp-card-header'>
                                            ...
                                            <div className='mhp-mode-toggle'>
                                                <button
                                                    className={classNames('mhp-mode-btn', {
                                                        active: scan_market_mode === 'multi',
                                                    })}
                                                ...
                                                <button
                                                    className={classNames('mhp-mode-btn', {
                                                        active: scan_market_mode === 'single',
                                                    })}
                                            ...
                                            <React.Fragment>
                                                ...
                                                >
                                                    {available_symbols.map((sym: any) => (
                                                        <option
                                                            key={sym.symbol || sym.underlying_symbol}
                                                            value={sym.symbol || sym.underlying_symbol}
                                                        >
                                                            {sym.display_name}
                                                        </option>
                                                    ))}
                                                ...
                                                <div className='mhp-single-price-box'>
                                                    <div>
                                                        ...
                                                        <span className='mhp-single-price'>
                                                            {displayPrice !== null
                                                                ? Number(displayPrice).toFixed(
                                                                      single_market_symbol.includes('1HZ') ? 2 : 4
                                                                  )
                                                                : 'Loading...'}
                                                        </span>
                                                    </div>
                                        ...
                                        <div className='mhp-strategy-line'>
                                            {[
                                                ...
                                                return (
                                                    <button
                                                        key={opt.key}
                                                        className={classNames('mhp-strategy-chip-single', {
                                                            active: isSelected,
                                                        })}
                                        ...
                                        <div className='mhp-grid-2'>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    value={scanner.stake}
                                                    onChange={e => {
                                                        scanner.stake = parseFloat(e.target.value) || 0;
                                                    }}
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => {
                                                        scanner.martingale_multiplier = parseFloat(e.target.value) || 0;
                                                    }}
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => {
                                                        scanner.take_profit = parseFloat(e.target.value) || 0;
                                                    }}
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => {
                                                        scanner.stop_loss = parseFloat(e.target.value) || 0;
                                                    }}
                                                />
                                            </div>
                                        </div>
                                    ...
                                    {selected_strategies.includes('over_under') && (
                                        <div className='mhp-card mhp-pred-card'>
                                            <div className='mhp-pred-header'>
                                                <span className='mhp-card-title'>
                                                    🎯 {localize('Over/Under Suggestive Predictions')}
                                                </span>
                                                <span className='mhp-pred-auto'>
                                                    {predictionChoice !== null
                                                        ? `Digit ${predictionChoice}`
                                                        : `Auto AI: ${autoDigit}`}
                                                </span>
                                            </div>
                                            <div className='mhp-digit-grid'>
                                                {[1, 2, 3, 6, 7, 8].map(d => (
                                                    <button
                                                        ...
                                                        onClick={() =>
                                                            setPredictionChoice(predictionChoice === d ? null : d)
                                                        }
                                                    >
                                    ...
                                    <div className='mhp-card mhp-signals-card' style={{ minHeight: 220 }}>
                                        <span className='mhp-card-title' style={{ marginBottom: 8, display: 'block' }}>
                                            ...
                                            {activeSelectedStrategySignals.length > 0 && (
                                                <span className='mhp-signal-count'>
                                                    {activeSelectedStrategySignals.length}
                                                </span>
                                            )}
                                        </span>
                                        {activeSelectedStrategySignals.length === 0 ? (
                                            <div className='mhp-empty-signals' style={{ padding: '24px 0' }}>
                                                ...
                                                <p>
                                                    {is_scanning
                                                        ? localize('Scanning markets for strategy signals...')
                                                        : localize('Click Scan to detect high-probability signals')}
                                                </p>
                                            </div>
                                        ) : (
                                            <div className='mhp-signals-list'>
                                                {activeSelectedStrategySignals.map((sig, idx) => {
                                                    const isSelected =
                                                        current_signal &&
                                                        current_signal.symbol === sig.symbol &&
                                                        current_signal.strategy === sig.strategy;
                                                    const isStrong = sig.confidence >= 0.9;
                                                    const color = statusColor(sig);
                                                    return (
                                                        <div
                                                            key={idx}
                                                            className={classNames('mhp-signal-row', {
                                                                selected: isSelected,
                                                                strong: isStrong,
                                                            })}
                                                            onClick={() => {
                                                        ...
                                                        >
                                                            <div
                                                                className='mhp-signal-rank'
                                                                style={{
                                                                    background:
                                                                        idx === 0
                                                                            ? 'linear-gradient(135deg,#f5c542,#e67e22)'
                                                                            : idx === 1
                                                            ...
                                                            <div className='mhp-signal-info'>
                                                                <div className='mhp-signal-header'>
                                                                    <span className='mhp-signal-symbol'>
                                                                        {sig.symbol}
                                                                    </span>
                                                                    <span className='mhp-signal-strategy'>
                                                                        {sig.strategy.replace(/_/g, ' ').toUpperCase()}
                                                                    </span>
                                                                    <span className='mhp-signal-pct' style={{ color }}>
                                                                        {(sig.confidence * 100).toFixed(0)}%
                                                                    </span>
                                                                </div>
                                                                <p className='mhp-signal-rec'>
                                                                    {sig.details.recommendation}
                                                                </p>
                                                                <p className='mhp-signal-entry'>
                                                                    {localize('Entry')}: {sig.details.entryCondition}
                                                                </p>
                                                            </div>
                                                            {isSelected && (
                                                                <span className='mhp-selected-indicator'>✓</span>
                                                            )}
                                                        </div>
                                                    );
                                                })}
                            ...
                            {activeTab === 'ai_automation' && (
                                <React.Fragment>
                                    ...
                                    <div
                                        className={classNames('mhp-card mhp-automation-box', {
                                            active: scanner.is_full_ai_automation,
                                        })}
                                        style={{ padding: 14 }}
                                    >
                                        <div className='mhp-automation-header'>
                                            <span
                                                className='mhp-automation-title'
                                                style={{ fontSize: 13, fontWeight: 800 }}
                                            >
                                                🤖 {localize('AI FULL AUTOMATION ENGINE')}
                                            </span>
                                            <button
                                                className={classNames('mhp-auto-badge', {
                                                    active: scanner.is_full_ai_automation,
                                                })}
                                                onClick={() =>
                                        ...
                                        <p className='mhp-dim' style={{ fontSize: 10, marginTop: 4 }}>
                                            {localize(
                                                'Actively scans live market feeds, auto-switches best market, limits auto-trades to 4 runs max before re-analyzing conditions.'
                                            )}
                                        </p>
                                    </div>
                                        ...
                                        <div className='mhp-strategy-line'>
                                            {[
                                                ...
                                                <button
                                                    key={opt.key}
                                                    className={classNames('mhp-strategy-chip-single', {
                                                        active: consoleTradeType === opt.key,
                                                    })}
                                                    onClick={() => {
                                    ...
                                    {consoleTradeType === 'over_under' && (
                                        <React.Fragment>
                                            <div className='mhp-ou-box'>
                                                <span className='mhp-card-title'>
                                                    📊 {localize('Over / Under Live Market Analysis')} (
                                                    {single_market_symbol})
                                                </span>

                                                <div className='mhp-ou-bar-container'>
                                                    <div
                                                        className={classNames('mhp-ou-fill-under', {
                                                            'glowing-win': isUnderDominant && underPct >= 55,
                                                        })}
                                                    ...
                                                    <div
                                                        className={classNames('mhp-ou-fill-over', {
                                                            'glowing-win': !isUnderDominant && overPct >= 55,
                                                        })}
                                                        style={{ width: `${overPct}%` }}
                                                    >
                                                ...
                                                >
                                                    <span>
                                                        ...
                                                        <strong style={{ color: '#60a5fa' }}>
                                                            Digit {highestUnderDigit}
                                                        </strong>
                                                    </span>
                                                    <span>
                                                        Highest in Over:{' '}
                                                        <strong style={{ color: '#34d399' }}>
                                                            Digit {highestOverDigit}
                                                        </strong>
                                                    </span>
                                                </div>
                                                ...
                                                {disturberDigit && (
                                                    <div className='mhp-disturber-warning'>
                                                        <span>⚠️ WARNING:</span>
                                                        <span>
                                                            {disturberDigit.side} Digit{' '}
                                                            <strong>{disturberDigit.digit}</strong> power is increasing
                                                            in recent 25 ticks (disturbing trend).
                                                        </span>
                                                    </div>
                                                )}
                                                ...
                                                {isStrongSignal && (
                                                    <div className='mhp-strong-signal-banner'>
                                                        <span>
                                                            ⚡ STRONG {isUnderDominant ? 'UNDER' : 'OVER'} SIGNAL
                                                        </span>
                                                        <span>
                                                            {isUnderDominant ? underPct.toFixed(0) : overPct.toFixed(0)}
                                                            % Dominance + Price Trend Aligned
                                                        </span>
                                                    </div>
                                                )}
                                                ...
                                                >
                                                    💡 <strong>Tick Sync & Pattern Skip:</strong> Entry point triggers
                                                    when Digit {isUnderDominant ? highestUnderDigit : highestOverDigit}{' '}
                                                    appears. Recommended <strong>2 ticks skip</strong> to bypass
                                                    opposite digit latency.
                                                </div>
                                            </div>
                                    ...
                                    {consoleTradeType === 'even_odd' && (
                                        <div className='mhp-ou-box'>
                                            <span className='mhp-card-title'>
                                                📊 {localize('Even / Odd Live Market Analysis')} ({single_market_symbol}
                                                )
                                            </span>
                                            ...
                                            <div className='mhp-ou-bar-container'>
                                                <div
                                                    className={classNames('mhp-ou-fill-under', {
                                                        'glowing-win': isEvenDominant && evenOddDev >= 7,
                                                    })}
                                                    style={{
                                                        width: `${evenPct}%`,
                                            ...
                                            >
                                                <span>
                                                    Highest Even Digit:{' '}
                                                    <strong style={{ color: '#60a5fa' }}>
                                                        Digit {highestEvenDigit}
                                                    </strong>
                                                </span>
                                                <span>
                                                    Highest Odd Digit:{' '}
                                                    <strong style={{ color: '#c084fc' }}>
                                                        Digit {highestOddDigit}
                                                    </strong>
                                                </span>
                                            </div>
                                            ...
                                            {evenOddDev >= 7 ? (
                                                <div className='mhp-strong-signal-banner'>
                                                    ...
                                                    <span>
                                                        {isEvenDominant ? evenPct.toFixed(0) : oddPct.toFixed(0)}%
                                                        Dominance ({evenOddDev.toFixed(0)}% Deviation ≥ 7%)
                                                    </span>
                                                </div>
                                            ) : (
                                                <div
                                                ...
                                                >
                                                    ℹ️ NEUTRAL EVEN/ODD BIAS: Current deviation is{' '}
                                                    <strong>{evenOddDev.toFixed(1)}%</strong> (Wait for ≥ 7% threshold).
                                                </div>
                                            )}
                                            ...
                                            >
                                                💡 <strong>Action:</strong> Auto-trades{' '}
                                                <strong>{isEvenDominant ? 'EVEN' : 'ODD'}</strong> when dominant side
                                                deviation reaches ≥ 7%.
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {consoleTradeType === 'differs' && (
                                        <div className='mhp-ou-box'>
                                            <span className='mhp-card-title'>
                                                📊 {localize('Digit Differs Coldest Analysis')} ({single_market_symbol})
                                            </span>
                                            ...
                                            >
                                                <span>
                                                    Coldest Digit:{' '}
                                                    <strong style={{ color: '#60a5fa' }}>
                                                        Digit {coldestDigitInfo.digit}
                                                    </strong>
                                                </span>
                                                <span>
                                                    Frequency:{' '}
                                                    <strong style={{ color: '#f5c542' }}>
                                                        {coldestDigitInfo.pct.toFixed(1)}%
                                                    </strong>{' '}
                                                    (Expected 10.0%)
                                                </span>
                                            </div>
                                            ...
                                            {coldestDigitInfo.pct <= 6.0 ? (
                                                <div className='mhp-strong-signal-banner'>
                                                    ...
                                                    <span>
                                                        Digit {coldestDigitInfo.digit} is Coldest at{' '}
                                                        {coldestDigitInfo.pct.toFixed(1)}%
                                                    </span>
                                                </div>
                                            ) : (
                                                ...
                                                >
                                                    ℹ️ WAITING FOR COLD DIGIT DROP: Digit {coldestDigitInfo.digit} is at{' '}
                                                    {coldestDigitInfo.pct.toFixed(1)}% (Threshold ≤ 6.0%).
                                                </div>
                                            )}
                                            ...
                                            >
                                                💡 <strong>Action:</strong> Buys{' '}
                                                <strong>Digit Differs {coldestDigitInfo.digit}</strong> when cold digit
                                                drops significantly below 10% mathematical expectation.
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {consoleTradeType === 'matches' && (
                                        <div className='mhp-ou-box'>
                                            <span className='mhp-card-title'>
                                                📊 {localize('Digit Matches Hottest Analysis')} ({single_market_symbol})
                                            </span>
                                            ...
                                            >
                                                <span>
                                                    Hottest Digit:{' '}
                                                    <strong style={{ color: '#f5c542' }}>
                                                        Digit {hottestDigitInfo.digit}
                                                    </strong>
                                                </span>
                                                <span>
                                                    Power Index:{' '}
                                                    <strong style={{ color: '#10b981' }}>
                                                        {hottestDigitInfo.pct.toFixed(1)}%
                                                    </strong>
                                                </span>
                                            </div>
                                            ...
                                            {hottestDigitInfo.pct >= 18.0 ? (
                                                <div className='mhp-strong-signal-banner'>
                                                    ...
                                                    <span>
                                                        Digit {hottestDigitInfo.digit} is Hottest at{' '}
                                                        {hottestDigitInfo.pct.toFixed(1)}% Recurring Power
                                                    </span>
                                                </div>
                                            ) : (
                                                <div
                                                ...
                                                >
                                                    ℹ️ WAITING FOR HOT DIGIT SPIKE: Digit {hottestDigitInfo.digit} is at{' '}
                                                    {hottestDigitInfo.pct.toFixed(1)}% (Threshold ≥ 18.0%).
                                                </div>
                                            )}
                                            ...
                                            >
                                                💡 <strong>Action:</strong> Buys{' '}
                                                <strong>Digit Matches {hottestDigitInfo.digit}</strong> on recurring
                                                high power score.
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {consoleTradeType === 'rise_fall' && (
                                        <div className='mhp-ou-box'>
                                            <span className='mhp-card-title'>
                                                📊 {localize('Rise / Fall Directional Trend Analysis')} (
                                                {single_market_symbol})
                                            </span>
                                            ...
                                            <div className='mhp-ou-bar-container'>
                                                <div
                                                    className={classNames('mhp-ou-fill-under', {
                                                        'glowing-win': riseFallTrend.dir === 'RISE',
                                                    })}
                                                    style={{
                                                        width: `${riseFallTrend.pct}%`,
                                                ...
                                                <div
                                                    className={classNames('mhp-ou-fill-over', {
                                                        'glowing-win': riseFallTrend.dir === 'FALL',
                                                    })}
                                                    style={{
                                                        width: `${100 - riseFallTrend.pct}%`,
                                            ...
                                            >
                                                <span>
                                                    ...
                                                    <strong
                                                        style={{
                                                            color: riseFallTrend.dir === 'RISE' ? '#34d399' : '#f87171',
                                                        }}
                                                    >
                                                        {riseFallTrend.dir}
                                                    </strong>
                                            ...
                                            >
                                                💡 <strong>Action:</strong> Buys <strong>{riseFallTrend.dir}</strong>{' '}
                                                following tick-by-tick price direction deviation.
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div className='mhp-console-card'>
                                        <span className='mhp-card-title' style={{ color: '#f5c542' }}>
                                            ⚡ {localize('TRADING CONSOLE')}
                                        </span>
                                        ...
                                        <div className='mhp-grid-2'>
                                            <div>
                                                ...
                                                <select
                                                    className='mhp-select'
                                                    value={consoleMarket}
                                                    onChange={e => setConsoleMarket(e.target.value)}
                                                >
                                                    {available_symbols.map((sym: any) => (
                                                        <option
                                                            key={sym.symbol || sym.underlying_symbol}
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    className='mhp-select'
                                                    value={consoleTradeType}
                                                    onChange={e => setConsoleTradeType(e.target.value)}
                                                >
                                        ...
                                        <div className='mhp-console-stats'>
                                            ...
                                            <div className='mhp-stat-box'>
                                                ...
                                                <span className='mhp-stat-val' style={{ color: '#10b981' }}>
                                                    {scanner.wins}
                                                </span>
                                            </div>
                                            <div className='mhp-stat-box'>
                                                <span className='mhp-stat-lbl'>{localize('Losses')}</span>
                                                <span className='mhp-stat-val' style={{ color: '#ef4444' }}>
                                                    {scanner.losses}
                                                </span>
                                            </div>
                                            <div className='mhp-stat-box'>
                                            ...
                                            <div className='mhp-stat-box'>
                                                ...
                                                <span
                                                    className={classNames(
                                                        'mhp-stat-val',
                                                        scanner.total_profit >= 0 ? 'mhp-profit-pos' : 'mhp-profit-neg'
                                                    )}
                                                >
                                                    {scanner.total_profit >= 0
                                                        ? `+$${scanner.total_profit.toFixed(2)}`
                                                        : `-$${Math.abs(scanner.total_profit).toFixed(2)}`}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div className='mhp-stats-strategy-row'>
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={classNames('mhp-stats-btn', {
                                                    active: statsStrategy === btn.key,
                                                })}
                                            >
                                                {btn.label}
                                            </button>
                                                    ...
                                                    .map(({ sym, key, analysis, statsData }) => (
                                                        <tr key={key}>
                                                            ...
                                                            <td style={{ fontFamily: 'monospace', fontSize: 11 }}>
                                                                {analysis
                                                                    ? analysis.lastQuote.toFixed(
                                                                          sym.display_name.includes('1s') ? 2 : 4
                                                                      )
                                                                    : '…'}
                                                            </td>
                            ...
                            {activeTab === 'dollarflipper' && (
                                ...
                                >
                                    ...
                                    <div
                                        className={classNames('mhp-df-status-banner', {
                                            running: store.dollarflipper.is_running,
                                        })}
                                    >
                                    ...
                                    <div className='mhp-grid-2'>
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={e =>
                                                    store.dollarflipper.setTargetProfit(parseFloat(e.target.value) || 0)
                                                }
                                            />
                                        </div>
                                        <div>
                                            <label className='mhp-label'>
                                                {localize('Initial Stake (% of Capital)')}
                                            </label>
                                            <select
                                                className='mhp-select'
                                                value={store.dollarflipper.stake_percentage}
                                                onChange={e =>
                                                    store.dollarflipper.setStakePercentage(
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={e =>
                                                    store.dollarflipper.setCompoundingMode(e.target.value as any)
                                                }
                                            >
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={e =>
                                                    store.dollarflipper.setStrategyType(e.target.value as any)
                                                }
                                            >
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={e =>
                                                    store.dollarflipper.setChallengeDays(parseInt(e.target.value) || 1)
                                                }
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={e =>
                                                    store.dollarflipper.setSessionsPerDay(parseInt(e.target.value) || 1)
                                                }
                                            >
                                    ...
                                    >
                                        ...
                                        <div className='mhp-df-step-container'>
                                            {[1, 2, 3, 4, 5].map(step => (
                                                <div
                                                    key={step}
                                                    className={classNames('mhp-df-step-chip', {
                                                        active: store.dollarflipper.compound_step === step,
                                                    })}
                                                >
                                    ...
                                    <div className='mhp-df-progress-box'>
                                        ...
                                        >
                                            ...
                                            >
                                                {localize('Session Profit Target')}
                                            </span>
                                            <span
                                                style={{
                                                    fontSize: 12,
                                                    fontWeight: 800,
                                                    color:
                                                        store.dollarflipper.current_session_profit >= 0
                                                            ? '#10b981'
                                                            : '#ef4444',
                                                }}
                                            >
                                                ${store.dollarflipper.current_session_profit.toFixed(2)} / $
                                                {store.dollarflipper.target_profit.toFixed(2)}
                                            </span>
                                        </div>
                                        <div className='mhp-progress-bg'>
                                            <div
                                                ...
                                                style={{
                                                    width: `${Math.min(100, Math.max(0, (store.dollarflipper.current_session_profit / store.dollarflipper.target_profit) * 100))}%`,
                                                }}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className='mhp-df-progress-box'>
                                        ...
                                        >
                                            <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)' }}>
                                                {localize('Completed Challenge Sessions:')}
                                            </span>
                                            <span style={{ fontSize: 12, fontWeight: 700, color: '#10b981' }}>
                                                {store.dollarflipper.completed_sessions} /{' '}
                                                {store.dollarflipper.challenge_days *
                                                    store.dollarflipper.sessions_per_day}
                                            </span>
                                        </div>
                                        <div className='mhp-progress-bg'>
                                            <div
                                    ...
                                    <div style={{ display: 'flex', gap: 8, marginTop: 'auto' }}>
                                        ...
                                        <button
                                            className={classNames('mhp-df-btn', {
                                                running: store.dollarflipper.is_running,
                                            })}
                                            onClick={() =>
                                                store.dollarflipper.is_running
                                        ...
                                        >
                                            {store.dollarflipper.is_running
                                                ? localize('⏸️ Pause Dollarflipper Engine')
                                                : localize('🚀 Launch Dollar Flipper Engine')}
                                        </button>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className='mhp-footer'>
                            <button
                                className='mhp-btn mhp-btn-scan'
                            ...
                            <button
                                className='mhp-btn mhp-btn-run'
                                onClick={handleLoadBotAndRun}
