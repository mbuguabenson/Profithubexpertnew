...
export const SUPPORTED_VOLATILITY_MARKETS: SupportedMarket[] = [
    ...
    { label: 'Volatility 150 (1s) Index', pip: 2, symbol: '1HZ150V' },
    { label: 'Volatility 200 (1s) Index', pip: 2, symbol: '1HZ200V' },
    { label: 'Volatility 250 (1s) Index', pip: 2, symbol: '1HZ250V' },
    { label: 'Volatility 300 (1s) Index', pip: 2, symbol: '1HZ300V' },
